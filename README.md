...
- **Syncthing Device Sync**: Automatically deliver collection files to KOReader devices and other Syncthing targets over a local network using the bundled Syncthing sidecar, with no cloud account required. See the [Syncthing setup guide](docs/SYNCTHING.md).
